...
public class AVRallocVars extends DepthFirstVisitor
{
    ...
    {
	    VarSTE f_ste = mCurrentST.lookupVar(node.getName());
	    f_ste.setLocation('Y', offset);
	    offset += f_ste.getType().getAVRTypeSize();
    }
    ...
    public void inMethodDecl(MethodDecl node)
    {
	    ...
	    VarSTE this_ste = mCurrentST.lookupVar("this");
	    this_ste.setLocation('Y', offset);
	    offset += this_ste.getType().getAVRTypeSize();
    }

    public void outMethodDecl(MethodDecl node)
    {
	    MethodSTE m_ste = mCurrentST.lookupMethod(node.getName());
	    m_ste.setSize(offset);
	    offset = 0;
	    mCurrentST.popScope();
    }
